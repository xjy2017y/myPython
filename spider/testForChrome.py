...
def is_similar2(image1,image2,x,y):
    pass
    pixel1=image1.getpixel((x,y))
    pixel2=image2.getpixel((x,y))
    [h1,s1,v1] = rgb2hsv(pixel1[0],pixel1[1],pixel1[2])
    [h2,s2,v2] = rgb2hsv(pixel2[0],pixel2[1],pixel2[2])
    if(abs(v1-v2) > 0.15):
        return False
    return True
...
#     打开网页
    driver.get("http://localhost:7995/")
...
#     下载图片
    ...
    #image1 = image.open('d:/picture/image1.jpg')
    #image2 = image.open('d:/picture/image2.jpg')
#     计算缺口位置
